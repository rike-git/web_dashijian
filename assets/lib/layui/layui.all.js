    ...
    (n.prototype.use = function (e, n, l) {
      ...
      if (o.modules[f])
        ...
        ;(h = h.replace(/^\{\/\}/, '')),
          ...
          d.appendChild(v),
          !v.attachEvent || (v.attachEvent.toString && v.attachEvent.toString().indexOf('[native code') < 0) || a
            ? v.addEventListener(
                'load',
                function (e) {
                  s(e, h)
        ...
        'function' != typeof n
          ...
          : ((function p() {
              return ++y > (1e3 * o.timeout) / 100
                ? i(e + ' timeout')
                : void (1989 === parseInt(a.getStyle(t.getElementById(c), 'width'))
                    ? (function () {
                        n()
                      })()
                    : setTimeout(p, 100))
      ...
      var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1,
        i = {
          ...
          page: (function () {
            ...
            return (
              a.pages > t && a.pages > u && a.last !== !1 && (u + 1 < a.pages && e.push('<span class="layui-laypage-spr">&#x2026;</span>'), 0 !== t && e.push('<a href="javascript:;" class="layui-laypage-last" title="&#x5C3E;&#x9875;"  data-page="' + a.pages + '">' + (a.last || a.pages) + '</a>')),
              e.join('')
            )
          })(),
          next: (function () {
  ...
  ;(C.prototype = []),
    ...
    (T.prototype.init = function () {
      ...
      ;(t.elem = w(t.elem)),
        ...
        t.elem[0] &&
          ...
          (t.mark = w.extend({}, t.calendar && 'cn' === t.lang ? { '0-1-1': '元旦', '0-2-14': '情人', '0-3-8': '妇女', '0-3-12': '植树', '0-4-1': '愚人', '0-5-1': '劳动', '0-5-4': '青年', '0-6-1': '儿童', '0-9-10': '教师', '0-9-18': '国耻', '0-10-1': '国庆', '0-12-25': '圣诞' } : {}, t.mark)),
    ...
    (T.prototype.render = function () {
      ...
      if (
        ...
        w(d).html(
          (function () {
            var e = [],
              i = []
            return (
              'datetime' === t.type && e.push('<span lay-type="datetime" class="laydate-btns-time">' + n.timeTips + '</span>'),
        ...
        var m = w.elem('style'),
          u = ['#{{id}} .layui-laydate-header{background-color:{{theme}};}', '#{{id}} .layui-this{background-color:{{theme}} !important;}']
            .join('')
          ...
          'string' == typeof l && l
            ? i.EXP_IF.test(l)
              ? r.range
                ...
                : m(o, l)
              : (i.hint('日期格式不合法<br>必须遵循下述格式：<br>' + (r.range ? r.format + ' ' + r.range + ' ' + r.format : r.format) + '<br>已为你重置'), (a = !0))
            : l && l.constructor === Date
            ? (r.dateTime = i.systemDate(l))
            : ((r.dateTime = i.systemDate()), delete i.startState, delete i.endState, delete i.startDate, delete i.endDate, delete i.startTime, delete i.endTime),
          c(o),
    ...
    (T.prototype.calendar = function (e) {
      ...
      if (
        ...
        u &&
          (s.range &&
            (e ? (r.endDate = r.endDate || { year: l.year + ('year' === s.type ? 1 : 0), month: l.month + ('month' === s.type ? 0 : -1) }) : (r.startDate = r.startDate || { year: l.year, month: l.month }),
            e &&
              ((r.listYM = [
      ...
      var t = this,
        ...
        s = function (s) {
          ...
          return (
            ...
            (d || c) && (w.extend(a, { year: o[0] }), i && (t[l].year = o[0]), n.range || t.done(null, 'change'), t.setBtnStatus(), n.range || t.limit(w(t.footer).find(g), { year: o[0] })),
            d || c
          )
        }
      return {
...
!(function (e, t) {
    ...
    for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)
      (r = e[a]),
        r.style &&
          ...
          (n = r.style.display),
          t ? (o[a] || 'none' !== n || (r.style.display = ''), '' === r.style.display && Re(r) && (o[a] = pe._data(r, 'olddisplay', j(r.nodeName)))) : ((i = Re(r)), ((n && 'none' !== n) || !i) && pe._data(r, 'olddisplay', i ? n : pe.css(r, 'display'))))
    ...
    (pe.extend = pe.fn.extend =
      function () {
        ...
        for ('boolean' == typeof a && ((l = a), (a = arguments[s] || {}), s++), 'object' == typeof a || pe.isFunction(a) || (a = {}), s === u && ((a = this), s--); s < u; s++)
          if (null != (i = arguments[s])) for (r in i) (e = a[r]), (n = i[r]), a !== n && (l && n && (pe.isPlainObject(n) || (t = pe.isArray(n))) ? (t ? ((t = !1), (o = e && pe.isArray(e) ? e : [])) : (o = e && pe.isPlainObject(e) ? e : {}), (a[r] = pe.extend(l, o, n))) : void 0 !== n && (a[r] = n))
        return a
      }),
    pe.extend({
        ...
        function (e) {
          ...
          return r !== H && 9 === r.nodeType && r.documentElement
            ? ((H = r),
              ...
              (w.matchesSelector = me.test((O = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector))) &&
                i(function (e) {
      ...
      (N = t.tokenize =
        function (e, n) {
          ...
          for (s = e, u = [], l = T.preFilter; s; ) {
            ...
            for (a in T.filter) !(i = pe[a].exec(s)) || (l[a] && !(i = l[a](i))) || ((r = i.shift()), o.push({ value: r, type: a, matches: i }), (s = s.slice(r.length)))
            if (!r) break
          }
    ...
    pe(function () {
      ...
      ;(n = re.getElementsByTagName('body')[0]),
        n &&
          ...
          'undefined' != typeof t.style.zoom && ((t.style.cssText = 'display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1'), (fe.inlineBlockNeedsLayout = e = 3 === t.offsetWidth), e && (n.style.zoom = 1)),
          n.removeChild(r))
    }),
    (function () {
          ...
          n && n.style
            ? ((t = re.createElement('div')),
              ...
              'undefined' != typeof t.style.zoom &&
                ((t.style.cssText = '-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1'), (t.appendChild(re.createElement('div')).style.width = '5px'), (e = 3 !== t.offsetWidth)),
              n.removeChild(r),
              e)
            : void 0
        )
  ...
  ;(pe.event = {
        ...
        for (
          ...
          (o = Qe.exec(t[s]) || []),
            ...
            p &&
              ...
              (l = pe.event.special[p] || {}),
              (f = pe.extend({ type: p, origType: g, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && pe.expr.match.needsContext.test(i), namespace: h.join('.') }, u)),
    ...
    (pe.Event = function (e, t) {
      return this instanceof pe.Event
        ? (e && e.type ? ((this.originalEvent = e), (this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && e.returnValue === !1) ? v : x)) : (this.type = e),
          t && pe.extend(this, t),
  ...
  pe.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if (
          ...
          null != n && n === n && ('number' === o && (n += (i && i[3]) || (pe.cssNumber[s] ? '' : 'px')), fe.clearCloneStyle || '' !== n || 0 !== t.indexOf('background') || (u[t] = 'inherit'), !(a && 'set' in a && void 0 === (n = a.set(e, n, r)))))
        )
          try {
            u[t] = n
          } catch (l) {}
    ...
    css: function (e, t, n, r) {
      var i,
        ...
        s = pe.camelCase(t)
      return (
        (t = pe.cssProps[s] || (pe.cssProps[s] = H(s) || s)), (a = pe.cssHooks[t] || pe.cssHooks[s]), a && 'get' in a && (o = a.get(e, !0, n)), void 0 === o && (o = gt(e, t, r)), 'normal' === o && t in Tt && (o = Tt[t]), '' === n || n ? ((i = parseFloat(o)), n === !0 || isFinite(i) ? i || 0 : o) : o
      )
    }
  }),
  ...
  ;(pe.Animation = pe.extend($, {
    ...
    (pe.speed = function (e, t, n) {
      var r = e && 'object' == typeof e ? pe.extend({}, e) : { complete: n || (!n && t) || (pe.isFunction(e) && e), duration: e, easing: (n && t) || (t && !pe.isFunction(t) && t) }
      return (
        (r.duration = pe.fx.off ? 0 : 'number' == typeof r.duration ? r.duration : r.duration in pe.fx.speeds ? pe.fx.speeds[r.duration] : pe.fx.speeds._default),
    ...
    pe.each({ slideDown: P('show'), slideUp: P('hide'), slideToggle: P('toggle'), fadeIn: { opacity: 'show' }, fadeOut: { opacity: 'hide' }, fadeToggle: { opacity: 'toggle' } }, function (e, t) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return 'undefined' == typeof e.getAttribute
            ...
            : ((1 === o && pe.isXMLDoc(e)) || ((t = t.toLowerCase()), (i = pe.attrHooks[t] || (pe.expr.match.bool.test(t) ? Ht : Lt))),
              void 0 !== n ? (null === n ? void pe.removeAttr(e, t) : i && 'set' in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ''), n)) : i && 'get' in i && null !== (r = i.get(e, t)) ? r : ((r = pe.find.attr(e, t)), null == r ? void 0 : r))
      },
      attrHooks: {
        type: {
          set: function (e, t) {
  ...
  pe.extend({
    ...
    ajax: function (t, n) {
      function r(t, n, r, i) {
        ...
        2 !== b &&
          ...
          (x = J(d, x, T, o)),
          o
            ? (d.ifModified && ((w = T.getResponseHeader('Last-Modified')), w && (pe.lastModified[a] = w), (w = T.getResponseHeader('etag')), w && (pe.etag[a] = w)),
              204 === t || 'HEAD' === d.type ? (C = 'nocontent') : 304 === t ? (C = 'notmodified') : ((C = x.state), (f = x.data), (v = x.error), (o = !v)))
      ...
      if (
        ...
        (d.dataTypes = pe
          ...
          .toLowerCase()
          .match(De) || ['']),
        null == d.crossDomain && ((i = Gt.exec(d.url.toLowerCase())), (d.crossDomain = !(!i || (i[1] === tn[1] && i[2] === tn[2] && (i[3] || ('http:' === i[1] ? '80' : '443')) === (tn[3] || ('http:' === tn[1] ? '80' : '443')))))),
    ...
    pe.each(['get', 'post'], function (e, t) {
      pe[t] = function (e, n, r, i) {
        return pe.isFunction(n) && ((i = i || r), (r = n), (n = void 0)), pe.ajax(pe.extend({ url: e, type: t, dataType: i, data: n, success: r }, pe.isPlainObject(e) && e))
      }
    }),
  ...
  return (
    ...
    pe.fn.extend({
      offset: function (e) {
        ...
        if (o)
          return (
            (t = o.documentElement), pe.contains(t, i) ? ('undefined' != typeof i.getBoundingClientRect && (r = i.getBoundingClientRect()), (n = te(o)), { top: r.top + (n.pageYOffset || t.scrollTop) - (t.clientTop || 0), left: r.left + (n.pageXOffset || t.scrollLeft) - (t.clientLeft || 0) }) : r
          )
      },
      position: function () {
        if (this[0]) {
          var e,
            ...
            r = this[0]
          return (
            'fixed' === pe.css(r, 'position') ? (t = r.getBoundingClientRect()) : ((e = this.offsetParent()), (t = this.offset()), pe.nodeName(e[0], 'html') || (n = e.offset()), (n.top += pe.css(e[0], 'borderTopWidth', !0)), (n.left += pe.css(e[0], 'borderLeftWidth', !0))),
...
!(function (e, t) {
  ...
  var i,
    ...
    r = {
      ...
      config: function (e, t) {
        return (
          (e = e || {}), (r.cache = o.config = i.extend({}, o.config, e)), (r.path = o.config.path || r.path), 'string' == typeof e.extend && (e.extend = [e.extend]), o.config.path && r.ready(), e.extend ? (a ? layui.addcss('modules/layer/' + e.extend) : o.link('theme/' + e.extend), this) : this
        )
      },
      ready: function (e) {
        var t = 'layer',
  ...
  ;(l.anim = ['layer-anim-00', 'layer-anim-01', 'layer-anim-02', 'layer-anim-03', 'layer-anim-04', 'layer-anim-05', 'layer-anim-06']),
    (s.pt.config = { type: 0, shade: 0.3, fixed: !0, move: l[1], title: '&#x4FE1;&#x606F;', offset: 'auto', area: 'auto', closeBtn: 1, time: 0, zIndex: 19891014, maxWidth: 360, anim: 0, isOutAnim: !0, icon: -1, moveType: 1, resize: !0, scrollbar: !0, tips: 2 }),
                  ...
                  i.extend(
                    {
                      ...
                      content:
                        ...
                        (u.length > 1 ? '<span class="layui-layer-imguide"><a href="javascript:;" class="layui-layer-iconext layui-layer-imgprev"></a><a href="javascript:;" class="layui-layer-iconext layui-layer-imgnext"></a></span>' : '') +
          ...
          var t = 200,
            ...
            b = function (l, o, r) {
              ...
              o.hasClass(u)
                ...
                : (f.addClass(h),
                  l.css({ left: c.position().left + parseFloat(c.css('marginLeft')), top: c.position().top + c.height() - l.height() }),
                  (e[r] = setTimeout(
                    function () {
              ...
              l.on('mouseleave', function () {
                clearTimeout(e[i]),
                  (p[i] = setTimeout(function () {
                    l.hasClass(u) ? o.css({ height: 0, top: o.position().top + o.height() / 2, opacity: 0 }) : o.css({ width: 0, left: o.position().left + o.width() / 2, opacity: 0 })
                  }, t))
              })),
    ...
    (f.prototype.render = function () {
      ...
      var p = t.disabled ? '#c2c2c2' : t.theme,
        f =
          ...
          p +
          ';"></div></div>' +
          (t.range ? '<div class="layui-slider-wrap" style="' + ('vertical' === t.type ? 'bottom' : 'left') + ':' + v + ';"><div class="layui-slider-wrap-btn" style="border: 2px solid ' + p + ';"></div></div>' : '') +
          '</div>',
        h = i(t.elem),
        y = h.next('.' + s)
      if (
      ...
      t.disabled ? (e.elemTemp.addClass(l), e.elemTemp.find('.' + u).addClass(l)) : e.slide(),
        e.elemTemp
          ...
          .on('mouseover', function () {
            ...
            e.elemTemp.find('.' + d).html(u), 'vertical' === t.type ? e.elemTemp.find('.' + d).css({ bottom: s + '%', 'margin-bottom': '20px', display: 'inline-block' }) : e.elemTemp.find('.' + d).css({ left: s + '%', display: 'inline-block' })
          })
    ...
    (f.prototype.slide = function (e, t, a) {
      var n = this,
        ...
        x = function (e, i) {
          ...
          'vertical' === l.type ? (s.find('.' + d).css({ bottom: e + '%', 'margin-bottom': '20px' }), (t = T(f() - h[0].offsetTop - h.height())), (a = l.range ? T(f() - h[1].offsetTop - h.height()) : 0)) : s.find('.' + d).css('left', e + '%'), (t = t > 100 ? 100 : t), (a = a > 100 ? 100 : a)
          var n = Math.min(t, a),
            o = Math.abs(t - a)
                  ...
                  f &&
                    ...
                    x.on('click', function () {
                      var e = t(this),
                        a = e.attr('lay-value'),
                        n = p.attr('lay-filter')
                      return !e.hasClass(c) && (e.hasClass('layui-select-tips') ? k.val('') : (k.val(e.text()), e.addClass(s)), e.siblings().removeClass(s), p.val(a).removeClass('layui-form-danger'), layui.event.call(this, l, 'select(' + n + ')', { elem: p[0], value: a, othis: i }), w(!0), !1)
                    }),
                        ...
                        layui.each(e, function (e, a) {
                          0 !== e || a.value
                            ? 'optgroup' === a.tagName.toLowerCase()
                              ...
                              : t.push('<dd lay-value="' + a.value + '" class="' + (d === a.value ? s : '') + (a.disabled ? ' ' + c : '') + '">' + a.innerHTML + '</dd>')
                  ...
                  [
                    ...
                    (function () {
                      var e = n.title.replace(/\s/g, ''),
                        t = { checkbox: [e ? '<span>' + n.title + '</span>' : '', '<i class="layui-icon layui-icon-ok"></i>'].join(''), _switch: '<em>' + ((n.checked ? s[0] : s[1]) || '') + '</em><i></i>' }
...
layui.define('form', function (e) {
  ...
  ;(b.prototype.config = { data: [], showCheckbox: !1, showLine: !0, accordion: !1, onlyIconControl: !1, isJump: !1, edit: !1, text: { defaultNodeName: '未命名', none: '无数据' } }),
    ...
    (b.prototype.tree = function (e, a) {
      ...
      layui.each(r, function (a, r) {
        var l = r.children && r.children.length > 0,
          ...
          h = i(
            [
              '<div data-id="' + r.id + '" class="layui-tree-set' + (r.spread ? ' layui-tree-spread' : '') + (r.checked ? ' layui-tree-checkedFirst' : '') + '">',
              '<div class="layui-tree-entry">',
              '<div class="layui-tree-main">',
              (function () {
                return t.showLine
                  ? l
                    ? '<span class="layui-tree-iconClick layui-tree-icon"><i class="layui-icon ' + (r.spread ? 'layui-icon-subtraction' : 'layui-icon-addition') + '"></i></span>'
              ...
              (function () {
                if (!t.edit) return ''
                var e = { add: '<i class="layui-icon layui-icon-add-1"  data-type="add"></i>', update: '<i class="layui-icon layui-icon-edit" data-type="update"></i>', del: '<i class="layui-icon layui-icon-delete" data-type="del"></i>' },
    ...
    (b.prototype.spread = function (e, a) {
      ...
      m.on('click', function (i) {
        ...
        k.on('click', function () {
          var n = i(this)
          n.hasClass(d) || ((x = e.hasClass(C) ? (t.onlyIconControl ? 'open' : 'close') : t.onlyIconControl ? 'close' : 'open'), t.click && t.click({ elem: e, state: x, data: a }))
        })
    }),
...
layui.define(['laytpl', 'form'], function (e) {
  ...
  ;(x.prototype.config = { title: ['列表一', '列表二'], width: 200, height: 360, data: [], value: [], showSearch: !1, id: '', text: { none: '无数据', searchNone: '无匹配数据' } }),
...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function (e) {
  ...
  ;(j.prototype.config = { limit: 10, loading: !0, cellMinWidth: 60, defaultToolbar: ['filter', 'exports', 'print'], autoSort: !0, text: { none: '无数据' } }),
    (j.prototype.render = function () {
      ...
      if (
        ...
        (a.response = t.extend({ statusName: 'code', statusCode: 0, msgName: 'msg', dataName: 'data', countName: 'count' }, a.response)),
        'object' == typeof a.page && ((a.limit = a.page.limit || a.limit), (a.limits = a.page.limits || a.limits), (e.page = a.page.curr = a.page.curr || 1), delete a.page.elem, delete a.page.jump),
        !a.elem[0])
      )
        return e
      ...
      var l = a.elem,
        n = l.next('.' + v),
        o = (e.elem = t(i(H).render({ VIEW_CLASS: v, data: a, index: e.index })))
      if (
        ((a.index = e.index),
        (e.key = a.id || a.index),
        n[0] && n.remove(),
    ...
    (j.prototype.renderToolbar = function () {
      ...
      var r = { filter: { title: '筛选列', layEvent: 'LAYTABLE_COLS', icon: 'layui-icon-cols' }, exports: { title: '导出', layEvent: 'LAYTABLE_EXPORT', icon: 'layui-icon-export' }, print: { title: '打印', layEvent: 'LAYTABLE_PRINT', icon: 'layui-icon-print' } },
        d = []
          ...
          return !r && c.sortKey
            ...
            : (layui.each(y, function (a, l) {
                ...
                0 !== l.length &&
                  ...
                  v.push('<tr data-index="' + a + '">' + y.join('') + '</tr>'),
                  m.push('<tr data-index="' + a + '">' + p.join('') + '</tr>'))
              }),
              ...
              list: (function () {
                ...
                return (
                  i.eachCols(function (t, i) {
                    i.field &&
                      'normal' == i.type &&
                      e.push('<li><input type="checkbox" name="' + i.field + '" data-key="' + i.key + '" data-parentkey="' + (i.parentKey || '') + '" lay-skin="primary" ' + (i.hide ? '' : 'checked') + ' title="' + (i.title || i.field) + '" lay-filter="LAY_TABLE_TOOL_COLS"></li>')
                  }),
                  e.join('')
                )
              })(),
      ...
      i.elem.on('click', 'input[name="layTableCheckbox"]+', function () {
        ...
        i.elem.on('click', 'input[lay-type="layTableRadio"]+', function () {
          ...
          layui.each(l, function (e, t) {
            ...
            layui.event.call(this, y, 'radio(' + p + ')', v.call(this, { checked: a }))
        }),
        i.layBody
...
layui.define('jquery', function (e) {
  ...
  ;(v.prototype.config = { length: 5, text: !1, readonly: !1, half: !1, value: 0, theme: '' }),
    (v.prototype.render = function () {
      ...
      ;(i.elem = a(i.elem)), parseInt(i.value) !== i.value && (i.half || (i.value = Math.ceil(i.value) - i.value < 0.5 ? Math.ceil(i.value) : Math.floor(i.value)))
  ...
  var e = layui.$,
    i = {
      ...
      timeAgo: function (t, e) {
        ...
        return a > 6912e5
          ? ((a = new Date(t)), (n[0][0] = i.digit(a.getFullYear(), 4)), (n[0][1] = i.digit(a.getMonth() + 1)), (n[0][2] = i.digit(a.getDate())), e || ((n[1][0] = i.digit(a.getHours())), (n[1][1] = i.digit(a.getMinutes())), (n[1][2] = i.digit(a.getSeconds()))), n[0].join('-') + ' ' + n[1].join(':'))
          : a >= 864e5
          ? ((a / 1e3 / 60 / 60 / 24) | 0) + '天前'
          : a >= 36e5
          ? ((a / 1e3 / 60 / 60) | 0) + '小时前'
    ...
    g = function (t, a, l) {
      var n = t.document,
        ...
        c = {
          ...
          help: function () {
            i.open({ type: 2, title: '帮助', area: ['600px', '380px'], shadeClose: !0, shade: 0.1, skin: 'layui-layer-msg', content: ['http://www.layui.com/about/layedit/help.html', 'no'] })
          }
        },
